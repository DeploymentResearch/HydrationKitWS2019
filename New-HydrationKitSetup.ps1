<#
    ...
    .EXAMPLE
   .\New-HydrationKitSetup.ps1 -Path C:\HydrationCMWS2019 -ShareName HydrationCMWS2019
#>
...
New-Item -path "DS001:\Media" -enable "True" -Name "MEDIA001" -Comments "" -Root "$Path\ISO" -SelectionProfile "Everything" -SupportX86 "False" -SupportX64 "True" -GenerateISO "True" -ISOName "HydrationCMWS2019.iso"  | Out-Null
