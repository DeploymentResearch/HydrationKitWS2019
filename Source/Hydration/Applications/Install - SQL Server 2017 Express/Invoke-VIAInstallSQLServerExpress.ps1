...
.DESCRIPTION
    Script for Deployment Fundamentals Vol 6
.EXAMPLE
    C:\Setup\Scripts\Invoke-VIAInstallSQLServerExpress.ps1 -Setup "C:\Setup\DL\SQL_2017_Express\SQLEXPRWT_x64_ENU.exe" -SQLINSTANCENAME "SQLExpress" -SQLINSTANCEDIR "E:\SQLDB"
.NOTES
    Created:	 2019-04-22
    Version:	 1.1
...
[Parameter(Mandatory=$false,Position=0)]
  $Setup = ".\Source\en_sql_server_2017_express_x64_11301593.exe",
...
Write-Verbose "Unpack SQL Express 2017"
Invoke-Exe -Executable $Setup -Arguments "/q /x:C:\SQLtmp"
Write-Verbose "Install SQL Express 2017, please wait"
